...
urlpatterns = [
    ...
    path('books/checkout/<int:book_id>/', views.check_out_book_view, name='check_out_book_view'),  # Check out a book
    path('books/return/<int:transaction_id>/', views.return_book_view, name='return_book_view'),  # Return a book
    path('transactions/', views.user_transactions_view, name='user_transactions_view'),  # Transaction history
